  ...
  return (
    <div className={`relative ${className}`}>
      <div
        ...
        className={`p-4 ${
          displayScrollbar
            ? "max-h-[400px] overflow-y-auto [&::-webkit-scrollbar]:w-[8px] [&::-webkit-scrollbar-track]:bg-[#120F17] [&::-webkit-scrollbar-thumb]:bg-[#222] [&::-webkit-scrollbar-thumb]:rounded-[4px]"
            : "h-auto overflow-visible scrollbar-hide"
        }`}
      ...
      >
        {items.map((item, index) => (
          ...
          >
            <div
              className={`transition-all duration-300 ${selectedIndex === index ? "opacity-100" : "opacity-90"} ${itemClassName}`}
            >
              {typeof item === 'string' ? (
